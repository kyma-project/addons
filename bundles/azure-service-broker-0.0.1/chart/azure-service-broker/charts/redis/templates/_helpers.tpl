...
We truncate at 45 chars because some Kubernetes name fields are limited to 63 (by the DNS naming spec)
so there are extra postfix place.
If release name contains chart name it will be used as a full name.
*/}}
{{- define "redis.fullname" -}}
{{- $name := default .Chart.Name .Values.nameOverride -}}
{{- printf "%s-%s" "azure-service-broker" $name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
